...
Feature: Peer Service
    As a user I want to be able have channels and chaincodes to process private data that would not be stored in ledger

@daily
Scenario Outline: FAB-3505: Test private chaincode marbles02_private deploy, invoke, and query
