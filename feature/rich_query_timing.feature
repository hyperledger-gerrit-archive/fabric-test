...
Scenario Outline: FAB-6256: Test rich queries using marbles chaincode using <language>
    ...
    #When a user invokes marble 1 to 80
    #And a user invokes marble 81 to 100 with owner "tom", color "pinkish" and size "30"
    And I wait "3" seconds

    #Simple Query
    When a user queries on the chaincode with args ["readMarble","marble81"]
    Then a user receives a response containing "name":"marble81"
    ...
    # queryMarbles-4field-swap
    When a user queries on the chaincode with args ["queryMarbles","{\\"selector\\":{\\"size\\":30,\\"owner\\":\\"tom\\",\\"color\\":\\"pinkish\\",\\"docType\\":\\"marble\\"}}"]
    Then a user receives a response containing "Key":"marble81"
    And a user receives a response containing "owner":"tom"
    And a user receives a response containing "name":"marble100"
    ...
    # queryMarbles-4field-swap-again
    When a user queries on the chaincode with args ["queryMarbles","{\\"selector\\":{\\"size\\":30,\\"owner\\":\\"tom\\",\\"color\\":\\"pinkish\\",\\"docType\\":\\"marble\\"}}"]
    Then a user receives a response containing "Key":"marble81"
    And a user receives a response containing "owner":"tom"
    And a user receives a response containing "name":"marble100"
    ...
    And I wait "3" seconds
    #Simple Query
    When a user queries on the chaincode with args ["readMarble","marble401"]
    Then a user receives a response containing "name":"marble401"
    And a user receives a response containing "owner":"tom"
    ...
    # queryMarbles-4field-swap
    When a user queries on the chaincode with args ["queryMarbles","{\\"selector\\":{\\"size\\":40,\\"owner\\":\\"tom\\",\\"color\\":\\"feroza\\",\\"docType\\":\\"marble\\"}}"]
    Then a user receives a response containing "Key":"marble401"
    And a user receives a response containing "owner":"tom"
    And a user receives a response containing "name":"marble500"
    ...
    #Simple Query
    When a user queries on the chaincode with args ["readMarble","marble901"]
    Then a user receives a response containing "name":"marble901"
    And a user receives a response containing "owner":"tom"
    ...
    # queryMarbles-4field-swap
    When a user queries on the chaincode with args ["queryMarbles","{\\"selector\\":{\\"size\\":50,\\"owner\\":\\"tom\\",\\"color\\":\\"cream\\",\\"docType\\":\\"marble\\"}}"]
    Then a user receives a response containing "Key":"marble901"
    And a user receives a response containing "owner":"tom"
    And a user receives a response containing "name":"marble1000"
    ...
    #Simple Query
    When a user queries on the chaincode with args ["readMarble","marble9901"]
    Then a user receives a response containing "name":"marble9901"
    And a user receives a response containing "owner":"tom"
    ...
    # queryMarbles-4field-swap
    When a user queries on the chaincode with args ["queryMarbles","{\\"selector\\":{\\"size\\":60,\\"owner\\":\\"tom\\",\\"color\\":\\"paste\\",\\"docType\\":\\"marble\\"}}"]
    Then a user receives a response containing "Key":"marble9901"
    And a user receives a response containing "owner":"tom"
    And a user receives a response containing "name":"marble10000"
