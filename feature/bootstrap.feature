...
#@smoke
# This test fails to change FABRIC_LOGGING_SPEC when using capabilities < V1_3.
# Other tests in daily suite may fail too if they require changes to that.
# When we finally update the capabilities, try to enable this again after updating capabilities.
