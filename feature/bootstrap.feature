...
Scenario: FAB-3635: Bootstrap Network from Configuration files
    Given we have a fabric config file
...
Scenario: FAB-3854: Ensure genesis block generated by configtxgen contains correct data
    ...
    And the orderer block "orderer.block" contains BEGIN CERTIFICATE
...
Scenario Outline: FAB-3858: Verify crypto material (TLS) generated by cryptogen
    Given we have a crypto config file with <numOrgs> orgs, <peersPerOrg> peers, <numOrderers> orderers, and <numUsers> users
    When the crypto material is generated for TLS network
    Then crypto directories are generated containing tls certificates for <numOrgs>, <peersPerOrg>, <numOrderers>, and <numUsers>
    Examples:
...
Scenario Outline: FAB-3856: Verify crypto material (non-TLS) generated by cryptogen
    ...
    Then crypto directories are generated containing certificates for <numOrgs>, <peersPerOrg>, <numOrderers>, and <numUsers>
    Examples:
       | numOrgs | peersPerOrg | numOrderers | numUsers |
       |    2    |      2      |      3      |     1    |
       |    3    |      2      |      3      |     3    |
