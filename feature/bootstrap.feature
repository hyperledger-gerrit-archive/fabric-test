...
Scenario: Setting of environment variables
    ...
    And the FABRIC_LOGGING_SPEC environment variable is gossip=DEBUG
    ...
    And the FABRIC_LOGGING_SPEC environment variable is gossip=DEBUG on node "peer1.org2.example.com"
