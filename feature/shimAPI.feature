...
# |        GetQueryResult 	                | eadMarbles,queryMarbles,queryMarblesByOwner  |
...
# |        InvokeChaincode                      |             ch_ex04 and ch_ex05          |
  ...
  When a user deploys chaincode at path "github.com/hyperledger/fabric-test/chaincodes/shimInterfaceAPIDriver" with args [""] with name "mycc"
...
#    Given I have a bootstrapped fabric network of type <type>  using state-database <database> with tls
  ...
  Examples:
    |                                  path                                  |  language |
    |  "github.com/hyperledger/fabric-test/chaincodes/shimInterfaceAPIDriver"|  GOLANG    |
