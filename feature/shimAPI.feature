...
# |        InvokeChaincode                      |             ch_ex04 and ch_ex05          |
  ...
  And I vendor go packages for fabric-based chaincode at "../chaincodes/marblesShimAPIDriver/go"
...
# Test getMarblesByRange
  ...
  When a user invokes on the chaincode named "mycc" with args ["testTxBinding"]
  ...
  Examples:
   ...
   | kafka |  leveldb |   30     | "github.com/hyperledger/fabric-test/chaincodes/marblesShimAPIDriver/go"     |
   | kafka |  couchdb |   30     | "github.com/hyperledger/fabric-test/chaincodes/marblesShimAPIDriver/go"      |
   | solo  |  leveldb |   20     | "github.com/hyperledger/fabric-test/chaincodes/marblesShimAPIDriver/go"      |
   | solo  |  couchdb |   20     | "github.com/hyperledger/fabric-test/chaincodes/marblesShimAPIDriver/go"      |
...
Scenario Outline: FAB-5791-2: Test rich queries using marbles chaincode using <language>
    ...
    And a user receives a response containing "name":"marble2"
  Examples:
    | waitTime |                                  path                                     |     language    |
    |   20     |  "github.com/hyperledger/fabric-test/chaincodes/marblesShimAPIDriver/go"  |     GOLANG      |
