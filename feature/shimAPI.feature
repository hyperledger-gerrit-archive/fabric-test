...
# Test getMarblesByRange
  ...
  Examples:
   ...
   | kafka |  leveldb |   30     | "github.com/hyperledger/fabric-test/chaincodes/shimInterfaceAPIDriveri/go"   |
   | kafka |  couchdb |   30     | "github.com/hyperledger/fabric-test/chaincodes/shimInterfaceAPIDriver/go"    |
   | solo  |  leveldb |   20     | "github.com/hyperledger/fabric-test/chaincodes/shimInterfaceAPIDriver/go"    |
   | solo  |  couchdb |   20     | "github.com/hyperledger/fabric-test/chaincodes/shimInterfaceAPIDriver/go"    |
...
Scenario Outline: FAB-5791-2: Test rich queries using marbles chaincode using <language>
  ...
  Examples:
    ...
    | solo  |  couchdb |   20     |  "github.com/hyperledger/fabric-test/chaincodes/shimInterfaceDriver/go"   |
    | kafka |  couchdb |   30     |  "github.com/hyperledger/fabric-test/chaincodes/shimInterfaceDriver/go"   |
