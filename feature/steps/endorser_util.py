...
class SDKInterface(InterfaceBase):
    ...
    def initializeNode(self):
        npminstall =  shutil.rmtree("./node_modules", ignore_errors=True)
        npminstall =  shutil.copyfile("package.json", "../../package.json")
        npminstall =  subprocess.check_call(["npm", "install", "--silent"], env=os.environ, cwd="../..")
        npminstall =  shutil.copytree("../../node_modules", "./node_modules")
...
class CLIInterface(InterfaceBase):
    ...
    def wait_for_deploy_completion(self, context, chaincode_container, timeout):
        ...
        # Wait for chaincode to complete initialization
        time.sleep(5)
