...
class InterfaceBase:
    ...
    def deploy_chaincode(self, context, path, args, name, language, version, peer, username, timeout, channel=TEST_CHANNEL_ID):
        self.pre_deploy_chaincode(context, path, args, name, language, version, peer, channel)
    ...
    def pre_deploy_chaincode(self, context, path, args, name, language, version, peer, channelId=TEST_CHANNEL_ID):
