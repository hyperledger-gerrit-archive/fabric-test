...
class InterfaceBase:
    ...
    def deploy_chaincode(self, context, path, args, name, language, peer, version, username, timeout, channel=TEST_CHANNEL_ID, policy=None):
        self.pre_deploy_chaincode(context, path, args, name, language, peer, version, channel, policy=policy)
