...
class SDKInterface(InterfaceBase):
    ...
    def initializeNode(self):
        npminstall =  subprocess.check_call(["npm", "install"], env=os.environ, cwd="./sdk/node")
    ...
    def invoke_chaincode(self, context, chaincode, orderer, peer, channelId=TEST_CHANNEL_ID):
        ...
        self.invoke_func.call("invokeChaincode", "User1", org, chaincode, peer, orderer, self.networkConfigFile)


#    def query_chaincode(self, context, chaincode, peer, channelId):
#        self.query_func.call("queryChaincode", "User1", org, chaincode, peer, self.networkConfigFile)
