...
class InterfaceBase:
    ...
    def instantiate_chaincode(self, context, peer, user="Admin", collections=None):
        return self.cli.instantiate_chaincode(context, peer, user=user, collectionConfig=collections)
