...
class InterfaceBase:
    ...
    def get_initial_leader(self, context, org):
        ...
        max_num_attempt=4
        wait_time=10
        while (org not in context.initial_leader) and (num_attempt<max_num_attempt):
        ...
        assert org in context.initial_leader.keys(), "Error: After " + (num_attempt*wait_time) + " seconds, no gossip-leader found by looking at the logs, for "+org
        return context.initial_leader[org]
    ...
    def get_initial_non_leader(self, context, org):
        ...
        assert org in context.initial_leader.keys(), "Error: No gossip-non-leader found by looking at the logs, for "+org
        return context.initial_non_leader[org]
