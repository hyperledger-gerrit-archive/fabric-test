...
@then(u'a user receives a {status} response of {response} from "{peer}"')
def expected_impl(context, response, peer, status="success"):
...
@then(u'a user receives a {status} response of {response}')
def step_impl(context, response, status="success"):
...
@then(u'a user receives response containing set {valueType} value from "{peer}"')
...
@then(u'a user receives response containing set {valueType} value')
