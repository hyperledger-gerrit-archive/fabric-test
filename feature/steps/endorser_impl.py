...
@when(u'I set up a channel named "{channelId}"')
...
@when(u'a user creates a channel "{channelID}"')
...
@when(u'I make all peers join the channel "{channelId}"')
...
@when(u'I make all peers join the channel')
def step_impl(context):
