...
def getKafkaBrokerList(context, orderer):
    ...
    # Be sure that a string containing a list of kafka brokers is returned
...
def getKafkaIPs(context, kafkaList):
    ...
    for kafka in kafkaList:
        ...
        container = context.composition.getContainerFromName(containerName, context.compose_containers)
...
def _testAccessPBMethods():
    ...
    assert isinstance(envelope, common_pb2.Envelope), "Unable to imported protobufs from bddtests directory"
