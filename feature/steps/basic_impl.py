...
@given(u'the initial elected-leader peer of "{org}" is taken down')
def step_impl(context, org):
    bringdown_impl(context, endorser_util.get_initial_elected_leader(context, org))
...
@given(u'the initial elected-leader peer of "{org}" comes back up')
def step_impl(context, org):
    bringup_impl(context, endorser_util.get_initial_elected_leader(context, org))
