...
Scenario Outline: Test chaincode API support for private data partitions
  ...
  When a user deploys chaincode at path "github.com/hyperledger/fabric/examples/chaincode/go/map" with args [] with name "marblecc"
  ...
  When a user queries on the chaincode named "marblecc" with args ["keysPrivate","col2","marble2",""]
