...
Scenario: FAB-8379: Test MSP Identity - Happy Path
  ...
  When a user sets up a channel
  And a user deploys chaincode with args ["init","a","1000","b","2000"] with policy "OR ('org1.example.com.member','org2.example.com.member')"
...
Scenario: FAB-8759: Test querying a peer with two different versions of chaincode - values change
  ...
  When a user installs chaincode at path "github.com/hyperledger/fabric/examples/chaincode/go/chaincode_example02" as version "3" with args ["init","a","1000","b","2000"] with name "vt" to "peer0.org1.example.com"
  When a user installs chaincode at path "github.com/hyperledger/fabric/examples/chaincode/go/chaincode_example02" as version "3" with args ["init","a","1000","b","2000"] with name "vt" to "peer1.org1.example.com"
  When a user installs chaincode at path "github.com/hyperledger/fabric/examples/chaincode/go/chaincode_example02" as version "3" with args ["init","a","1000","b","2000"] with name "vt" to "peer0.org2.example.com"
  When a user installs chaincode at path "github.com/hyperledger/fabric/examples/chaincode/go/chaincode_example02" as version "3" with args ["init","a","1000","b","2000"] with name "vt" to "peer0.org2.example.com"
  And I wait "5" seconds
  ...
  Then a user receives a success response of 1000
  When a user queries on version "0" of the channel "versioningtest" using chaincode named "vt" with args ["query","a"] on "peer0.org1.example.com"
  Then a user receives a success response of 1000
...
Scenario: FAB-8759: Test querying a peer that has two different versions of chaincode - no change in data
  ...
  When a user installs chaincode at path "github.com/hyperledger/fabric/examples/chaincode/go/map" as version "4" with args ["init"] with name "vt" to "peer0.org1.example.com"
  When a user installs chaincode at path "github.com/hyperledger/fabric/examples/chaincode/go/map" as version "4" with args ["init"] with name "vt" to "peer1.org1.example.com"
  When a user installs chaincode at path "github.com/hyperledger/fabric/examples/chaincode/go/map" as version "4" with args ["init"] with name "vt" to "peer0.org2.example.com"
  When a user installs chaincode at path "github.com/hyperledger/fabric/examples/chaincode/go/map" as version "4" with args ["init"] with name "vt" to "peer0.org2.example.com"
  And I wait "5" seconds
  When a user upgrades the chaincode on channel "versioningtest" to version "4" on peer "peer0.org1.example.com" with args ["init"]
  #When a user upgrades the chaincode on channel "versioningtest" to version "4" on peer "peer0.org1.example.com"
  ...
  Then a user receives a success response of "1000"
  When a user queries on version "0" of the channel "versioningtest" using chaincode named "vt" with args ["get","c"] on "peer0.org1.example.com"
