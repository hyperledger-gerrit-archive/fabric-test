...
Examples:
    ...
    | solo  | leveldb  |    15     |  with tls   |
    | solo  | leveldb  |    15     | without tls |
    | solo  | couchdb  |    15     |  with tls   |
    | solo  | couchdb  |    15     | without tls |
    | kafka | leveldb  |    70     |  with tls   |
    | kafka | leveldb  |    70     | without tls |
    | kafka | couchdb  |    70     |  with tls   |
    | kafka | couchdb  |    70     | without tls |
