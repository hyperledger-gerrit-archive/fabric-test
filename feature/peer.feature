...
Scenario Outline: FAB-3505: Test chaincode example02 deploy, invoke, and query, with <type> orderer
    ...
    And an admin deploys chaincode at path "github.com/hyperledger/fabric/examples/chaincode/go/chaincode_example02" with args ["init","a","1000","b","2000"] with name "mycc"
...
Scenario Outline: FAB-3865: Multiple Channels Per Peer, with <type> orderer
    ...
    And an admin deploys chaincode at path "github.com/hyperledger/fabric/examples/chaincode/go/chaincode_example02" with args ["init", "a", "1000" , "b", "2000"] with name "cc1" on channel "chn1"
...
Scenario Outline: FAB-3866: Multiple Chaincodes Per Peer, with <type> orderer
    ...
    When an admin deploys chaincode at path "github.com/hyperledger/fabric/examples/chaincode/go/chaincode_example02" with args ["init", "a", "1000" , "b", "2000"] with name "example02"
...
Scenario: FAB-8759: Test querying a peer with two different versions of chaincode - values change
  ...
  And an admin deploys chaincode at path "github.com/hyperledger/fabric/examples/chaincode/go/chaincode_example02" with args ["init", "a", "1000" , "b", "2000"] with name "vt" on channel "versioningtest"
  ...
  When an admin installs chaincode at path "github.com/hyperledger/fabric/examples/chaincode/go/chaincode_example02" as version "3" with args ["init","a","1000","b","2000"] with name "vt" on all peers
  And I wait "5" seconds
  When an admin upgrades the chaincode on channel "versioningtest" to version "3" on peer "peer0.org1.example.com" with args ["init","a","1000","b","2000"]
...
Scenario: FAB-8759: Test querying a peer that has two different versions of chaincode - no change in data
  ...
  And I wait "5" seconds
  When an admin upgrades the chaincode on channel "versioningtest" to version "4" on peer "peer0.org1.example.com" with args ["init"]
...
Scenario: FAB-7407: Update the channel policies - add an organization
  ...
  When an admin installs chaincode at path "github.com/hyperledger/fabric/examples/chaincode/go/chaincode_example02" as version "2" with args ["init","a","1000","b","2000"] on all peers
  And I wait "5" seconds
