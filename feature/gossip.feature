...
Scenario Outline: [FAB-4679] [FAB-4680] [FAB-4681] In leader-selection setup, a non-leader peer goes down by <takeDownType>, comes back up and catches up eventually
  ...
  Given the PEER0_ORG1_IFLEADER environment variable is true
  And the PEER0_ORG1_IFLEADERELECTION environment variable is false
  And the PEER0_ORG2_IFLEADER environment variable is true
  And the PEER0_ORG2_IFLEADERELECTION environment variable is false
  And the PEER1_ORG1_IFLEADER environment variable is false
  And the PEER1_ORG1_IFLEADERELECTION environment variable is false
  And the PEER1_ORG2_IFLEADER environment variable is false
  And the PEER1_ORG2_IFLEADERELECTION environment variable is false
