...
@daily
Scenario Outline: [FAB-4663] [FAB-4664] [FAB-4665] A non-leader peer goes down (stops/pauses/disconnects from network) temporarily, is expected to catch up and have all missing blocks eventually
...
#    | kafka |    10    |  stop        | start       |
#    | kafka |    10    |  pause       | unpause     |
#    | kafka |    10    | disconnect   | connect     |
