...
Scenario: FAB-13983: Test new chaincode lifecycle - Chaincode calling chaincode
  ...
  And an admin packages chaincode at path "github.com/hyperledger/fabric/examples/chaincode/go/example04/cmd" with name "ex04"
  And an admin packages chaincode at path "github.com/hyperledger/fabric/examples/chaincode/go/example02/cmd" with name "ex02"
