...
Examples:
    ...
    | solo  | 2097152 |           2MB                |
    | solo  | 4194304 |           4MB                |
    | kafka |  125000 | 12KB (with default msg size) |
    | kafka |  320000 | 32KB (with default msg size) |
    #| kafka | 1000012 |           1MB                |


@daily
Scenario Outline: FAB-3859: Kafka Network with Message Size <comment> with Configuration Tweaks
