...
Examples:
    ...
    | solo |    30    | github.com/hyperledger/fabric/examples/chaincode/go/chaincode_example02 | GOLANG | with tls    |
    | solo |    30    | github.com/hyperledger/fabric/examples/chaincode/go/chaincode_example02 | GOLANG | without tls |
    | solo |    30    | ../../fabric-test/chaincodes/example02/node                             | NODE   | with tls    |
    | solo |    30    | ../../fabric-test/chaincodes/example02/node                             | NODE   | without tls |
...
Scenario Outline: FAB-6256: Test rich queries using marbles chaincode
  ...
  Examples:
    ...
    | solo |    30    | github.com/hyperledger/fabric/examples/chaincode/go/marbles02 | GOLANG   | with tls    |
    | solo |    30    | ../../fabric-test/chaincodes/marbles/node                     | NODE     | with tls    |
