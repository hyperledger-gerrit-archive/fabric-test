...
# Test getMarblesByRange
  ...
  Examples:
   ...
   | solo  |  leveldb | /opt/gopath/src/github.com/hyperledger/fabric-test/chaincodes/marbles/node | /opt/gopath/src/github.com/hyperledger/fabric-test/chaincodes/shimApiDriver/node | NODE    |
   | kafka |  couchdb | /opt/gopath/src/github.com/hyperledger/fabric-test/chaincodes/marbles/node | /opt/gopath/src/github.com/hyperledger/fabric-test/chaincodes/shimApiDriver/node | NODE    |
