...
# |        InvokeChaincode                      |           FAB-4717  ch_ex05 calling ch_ex02           |
  ...
  Given I have a bootstrapped fabric network of type <type>
  When a user sets up a channel
  And I vendor "<language>" packages for fabric-based chaincode at "<shimAPIDriverPath>"
...
# Test getMarblesByRange
  ...
  Examples:
   ...
   | solo  |  leveldb | github.com/hyperledger/fabric/examples/chaincode/go/marbles02              | ../chaincodes/shimApiDriver/go   | GOLANG  |
   | kafka |  couchdb | github.com/hyperledger/fabric/examples/chaincode/go/marbles02              | ../chaincodes/shimApiDriver/go   | GOLANG  |
   | solo  |  leveldb | /opt/gopath/src/github.com/hyperledger/fabric-test/chaincodes/marbles/node | ../chaincodes/shimApiDriver/node | NODE    |
   | kafka |  couchdb | /opt/gopath/src/github.com/hyperledger/fabric-test/chaincodes/marbles/node | ../chaincodes/shimApiDriver/node | NODE    |
