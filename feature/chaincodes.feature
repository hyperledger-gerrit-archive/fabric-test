...
@smoke
Scenario Outline: FAB-6211: Test chaincodes written in various languages
...
Examples:
    ...
    | kafka |    30    | ../../fabric-test/feature/chaincode/node/example02                      | NODE   | with tls    |
    | kafka |    30    | ../../fabric-test/feature/chaincode/node/example02                      | NODE   | without tls |
