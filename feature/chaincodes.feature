...
@daily
Scenario Outline: FAB-xxxx: Test chaincode - fabric/examples/chaincode_example02 deploy, invoke, and query
...
#@daily
#Scenario Outline: FAB-xxxx: Test chaincode - fabric/examples/chaincode_example02 deploy, invoke, and query with chaincode in all uppercase chars
#  Given I have a bootstrapped fabric network of type <type>
#  And I wait "<waitTime>" seconds
#  When a user deploys chaincode at path "github.com/hyperledger/fabric/examples/chaincode/go/chaincode_example02" with args ["init","a","1000","b","2000"] with name "MYCC"
#  And I wait "5" seconds
...
#@daily
#Scenario Outline: FAB-xxxx: Test chaincode - fabric/examples/chaincode_example02 deploy, invoke, and query with chaincode in mixcase chars
#  Given I have a bootstrapped fabric network of type <type>
#  And I wait "<waitTime>" seconds
...
#  And a user queries on the chaincode named "MYcc_Test" with args ["query","a"]
#  Then a user receives a success response of 990
#  Examples:
#    | type  | waitTime |
#    | solo  |    5     |
...
@daily
Scenario: FAB-5791: Chaincode to test shim interface API
  Given I have a bootstrapped fabric network of type <type> 
  And I wait "60" seconds
