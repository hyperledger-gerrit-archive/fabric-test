...
Scenario Outline: FAB-6439: Test chaincode enccc_example.go which uses encshim library extensions.
  #For keys, we have used what is provided in README.md under "gitgithub.com/hyperledger/fabric/examples/chaincode/go/enccc_example"
...
@skip
Scenario Outline: FAB-6439-1: Test chaincode enccc_example.go negative scenario, passing in bad ENCRYPTION(ENC), IV, and SIGNATURE(SIG) KEYS
  #For keys, we have used what is provided in README.md under "github.com/hyperledger/fabric/examples/chaincode/go/enccc_example" folder
  # ENCKEY=`openssl rand 32 -base64`
  # IV=`openssl rand 16 -base64`
  # SIGKEY=`openssl ecparam -name prime256v1 -genkey | tail -n5 | base64 -w0`
