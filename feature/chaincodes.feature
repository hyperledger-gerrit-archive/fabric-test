...
@daily
Scenario Outline: FAB-6439: Test chaincode enccc_example.go which uses encshim library extensions. Includes negative scenarios by passing in incorrect KEYS
