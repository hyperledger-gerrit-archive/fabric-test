...
@doNotDecompose
@revoke
Scenario Outline: FAB-JAVA: Interoperability Test using <type> based orderer
    #Given I have a bootstrapped fabric network of type <type> using state-database <database> with tls
    Given I have a bootstrapped fabric network of type <type> using state-database <database> without tls
