...
usage () {
    ...
    echo -e "examples:"
    echo -e "./runCloudPTE.sh --npm --cprof IBM/creds/connectionprofiles -t FAB-3808-2i"
    echo -e "./runCloudPTE.sh --cprof IBM/creds/connectionprofiles -t FAB-3808-2i FAB-3811-2q"
    echo -e "./runCloudPTE.sh --cprof IBM/creds/connectionprofiles -a"
    echo
