...
alert $? "Successfully downloaded the connection profile for Org ${ORG1_NAME}\n"
...
if [ ! -f bin/fabric-ca-client ]; then
	...
	alert $? "Successfully downloaded the fabric-ca-client binary\n\n"
else
...
if [ "$IS_ENTERPRISE" != true ]; then
	...
	alert $? "Successfully downloaded the connection profile for Org ${ORG2_NAME}\n"
