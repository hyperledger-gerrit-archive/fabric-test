...
dockerTag() {
  ...
  docker pull $NEXUS_URL/$ORG_NAME-buildenv:amd64-1.4.0-stable-1aa5b47
  docker tag $NEXUS_URL/$ORG_NAME-buildenv:amd64-1.4.0-stable-1aa5b47 $ORG_NAME-buildenv
  docker tag $NEXUS_URL/$ORG_NAME-buildenv:amd64-1.4.0-stable-1aa5b47 $ORG_NAME-buildenv:$LATEST_TAG
  docker rmi -f $NEXUS_URL/$ORG_NAME-buildenv:amd64-1.4.0-stable-1aa5b47
