...
third-party)
  ...
  docker pull $NEXUS_URL/hyperledger/fabric-kafka:amd64-0.4.14
  docker pull $NEXUS_URL/hyperledger/fabric-zookeeper:amd64-0.4.14
  docker pull $NEXUS_URL/hyperledger/fabric-couchdb:amd64-0.4.14
  ;;
*)
