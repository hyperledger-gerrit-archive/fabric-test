...
#    Then the orderers will reject the update
    ...
    # Issue another TX, and verify the peers each have the same height (even though through direct connect to orderer, and NOT gossip)
...
#      | configAdminOrdererOrg1 | config-admin-cert |
    ...
    And the user "dev0Org0" creates a new channel ConfigUpdate "createChannelConfigUpdate2" using consortium "consortium1"
      | ChannelID                         | PeerOrgSet  | [PeerAnchorSet] |
