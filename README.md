...
* Update git submodules and install all the python required modules in virtual environment, including python, python-pytest, and everything else identified in fabric-test/feature/scripts/install_behave.sh.
