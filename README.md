...
#### Set up git hooks and git review
...
```make ci-daily```    - Cleans environment, updates submodules, clones & builds fabric & fabric-ca images, 
 executes Daily tests from regression/daily folder.

```make ci-smoke```    - Cleans environment, updates submodules, clones & builds fabric & fabric-ca images, 
 executes Smoke tests from regression/smoke folder.
