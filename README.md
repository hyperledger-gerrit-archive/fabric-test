...
If you have not already done so, clone the `fabric-test` repository into $GOPATH/src/github.com/hyperledger/.
The git submodules need to be initialized when the repository is first cloned.
```
