...
usage () {
    ...
    echo -e "--cpdir \trelative path from current directory to the directory that contains connection profiles to be converted"
    ...
    echo -e "examples:"
    echo -e "./runPTE.sh --npm --cpdir connectionprofile -t FAB-3808-2i"
    echo -e "./runPTE.sh --cpdir connectionprofile -t FAB-3808-2i FAB-3811-2q"
    echo -e "./runPTE.sh -a"
    echo
