...
if [ ! -d $FabricTestDir/../fabric ]; then
    printf "Error: fabric directory not available in \$FabricTestDir/../fabric.\nPlease clone fabric repository in \$FabricTestDir/../ before running LTE.\n"
    exit 1
  fi
