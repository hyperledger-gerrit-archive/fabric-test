...
func (c CreateChannelObject) generateCreateChannelObjects(channel helper.Channel, organizations []helper.Organization, TLS, channelTx string) ([]CreateChannelObject, error) {
