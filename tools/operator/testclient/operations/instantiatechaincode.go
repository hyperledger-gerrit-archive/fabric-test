...
func (i InstantiateChainCodeObject) createInstantiateCCObjects(orgNames []string, channelName, tls string, organizations []helper.Organization, ccObject helper.InstantiateCC) ([]InstantiateChainCodeObject, error) {
	...
	for _, orgName := range orgNames {
		...
		i = InstantiateChainCodeObject{TransType: "instantiate", TLS: tls, ConnProfilePath: paths.GetConnProfilePathForOrg(orgName, organizations), ChainCodeID: ccObject.ChainCodeName, ChainCodeVer: ccObject.ChainCodeVersion}
