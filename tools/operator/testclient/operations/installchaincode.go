...
//InstallChainCode --
func (i ChainCodeObject) InstallChainCode(config helper.Config) error {

	var installCCObjects []ChainCodeObject
	var tls string
	switch tls {
	case "true":
		tls = "enabled"
...
func (i ChainCodeObject) installChainCodeObjects(ccObject helper.InstallCC, organizations []helper.Organization, tls string) []ChainCodeObject {

	var installCCObjects []ChainCodeObject
	var channelOpt ChannelOptions
	var deploy Deploy
	i = ChainCodeObject{TransType: "install", TLS: tls, ChainCodeVer: ccObject.ChainCodeVersion}
...
func (i ChainCodeObject) getConnProfilePathForOrg(orgName string, organizations []helper.Organization) string {
...
func (i ChainCodeObject) installChaincode(installChainCodeObjects []ChainCodeObject) error {
