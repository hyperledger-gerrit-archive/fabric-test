...
func (j JoinChannelObject) JoinChannels(config helper.Config, tls string) error {
...
func (j JoinChannelObject) createJoinChannelObjects(orgNames []string, channelName, tls string, channel helper.Channel, organizations []helper.Organization) []JoinChannelObject {
	...
	for _, orgName := range orgNames {
		...
		j = JoinChannelObject{TransType: "Channel", TLS: tls, ConnProfilePath: paths.GetConnProfilePathForOrg(orgName, organizations), ChannelOpt: channelOpt}
