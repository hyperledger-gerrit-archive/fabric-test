...
func (k K8s) K8sServicePort(serviceName, serviceType string, forHealth bool) (int, error) {
	...
	if serviceType == "LoadBalancer" {
		portNumber = k8Ports.Spec.Ports[0].TargetPort, nil
		if forHealth{
			portNumber = k8Ports.Spec.Ports[index].NodePort, nil	
		}
	}
