...
const getLTE = (req,res) => {
	...
	request(`https://logs.hyperledger.org/production/vex-yul-hyp-jenkins-3/fabric-test-daily-lte-master-x86_64/${buildnum}/LTE_Test_Results/experiments/BenchmarkReadWriteTxs``, { json: false }, (err, response, body) => {
