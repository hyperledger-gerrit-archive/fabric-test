...
const fetchBuild = (req, res) => {
	...
	urls = {
		'pte': 'https://jenkins.hyperledger.org/view/fabric-test/job/fabric-test-daily-pte-master-x86_64',
		'ote': 'https://jenkins.hyperledger.org/view/fabric-test/job/fabric-test-daily-ote-master-x86_64',
		'lte': 'https://jenkins.hyperledger.org/view/fabric-test/job/fabric-test-daily-lte-master-x86_64'
	}
	url = urls[tool]
...
const getLTE = (req,res) => {
	...
	const url_lte = `https://logs.hyperledger.org/production/vex-yul-hyp-jenkins-3/fabric-test-daily-lte-master-x86_64/${buildnum}/LTE_Test_Logs/results.csv`
	...
	request(`https://logs.hyperledger.org/production/vex-yul-hyp-jenkins-3/fabric-test-daily-lte-master-x86_64/${buildnum}/LTE_Test_Logs`, { json: false }, (err, response, body) => {
