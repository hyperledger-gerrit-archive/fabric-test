...
const pte_base = {'2018-06-07':1}
const svt_base = {'2018-06-07':1}
...
const getPTE = (req,res) => {
	/*
	Fetches PTE metrics based on date. 

	Implement at some point storing into database so that metrics don"t have to
	be scraped anew every time a date is selected.

	If all logs are formatted exactly the same, then reformat code below to access
	the metrics more directly
	*/
