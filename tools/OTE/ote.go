...
func newOrdererdriveClient(client ab.AtomicBroadcast_DeliverClient, chanID string, signer mockLocalSigner, quiet bool) *ordererdriveClient {
...
func newBroadcastClient(client ab.AtomicBroadcast_BroadcastClient, chanID string, signer mockLocalSigner) *broadcastClient {
