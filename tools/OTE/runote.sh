...
FAB-7058 () {
        ...
        cd $OTE_DIR
        # run testcase
        numChannels=1 testcase=Test_FAB7058_30000TX_1ch_6ord_5kb docker-compose -f ote-compose.yml up -d
}
...
FAB-7078 () {
        ...
        cd $OTE_DIR
        # run testcase
        numChannels=1 testcase=Test_FAB7078_30000TX_1ch_6ord_5kb_10kpayload docker-compose -f ote-compose.yml up -d
}
...
FAB-7059 () {
        ...
        cd $OTE_DIR
        # run testcase
        numChannels=1 testcase=Test_FAB7059_30000TX_1ch_6ord_5kb_500batchsize docker-compose -f ote-compose.yml up -d
}
...
FAB-7079 () {
        ...
        cd $OTE_DIR
        # run testcase
        numChannels=1 testcase=Test_FAB7079_30000TX_1ch_6ord_5kb_500batchsize_10kpayload docker-compose -f ote-compose.yml up -d
}
...
FAB-7060 () {
        ...
        cd $OTE_DIR
        # run testcase
        numChannels=3 testcase=Test_FAB7060_30000TX_3ch_6ord_5kb docker-compose -f ote-compose.yml up -d
}
...
FAB-7080 () {
        ...
        cd $OTE_DIR
        # run testcase
        numChannels=3 testcase=Test_FAB7080_30000TX_3ch_6ord_5kb_10kpayload docker-compose -f ote-compose.yml up -d
}
...
FAB-7061 () {
        ...
        cd $OTE_DIR
        # run testcase
        numChannels=3 testcase=Test_FAB7061_30000TX_3ch_6ord_5kb_500batchsize docker-compose -f ote-compose.yml up -d
}
...
FAB-7081 () {
        ...
        cd $OTE_DIR
        # run testcase
        numChannels=3 testcase=Test_FAB7081_30000TX_3ch_6ord_5kb_500batchsize_10kpayload docker-compose -f ote-compose.yml up -d
}
