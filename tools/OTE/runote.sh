...
function printHelp {
   ...
   echo "    -q <orderer loglevel (default $OLOGLVL)>    # orderer logging spec <CRITICAL|ERROR|WARNING|NOTICE|INFO|DEBUG>"
   echo "    -l <core peer loglevel (default $PLOGLVL)>  # a few peer log specs <CRITICAL|ERROR|WARNING|NOTICE|INFO|DEBUG>"
   echo " "
   echo "Examples: "
