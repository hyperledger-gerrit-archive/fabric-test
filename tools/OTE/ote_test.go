...
func Test_FAB7027_30000TX_3ch_1ord_solo_500batchsize(t *testing.T) {
        passResult, finalResultSummaryString := ote("FAB-7027", 30000, 3, 1, "solo", 0, spyOff, 1 )
        if !passResult { t.Error(finalResultSummaryString) }
}
...
func Test_FAB7038_30000TX_3ch_3ord_5kb(t *testing.T) {
        passResult, finalResultSummaryString := ote("FAB-7038", 30000, 3, 3, "kafka", 5, spyOff, 1 )
        if !passResult { t.Error(finalResultSummaryString) }
}
...
func Test_FAB7039_30000TX_3ch_3ord_5kb_500batchsize(t *testing.T) {
        passResult, finalResultSummaryString := ote("FAB-7039", 30000, 3, 3, "kafka", 5, spyOff, 1 )
        if !passResult { t.Error(finalResultSummaryString) }
}
...
func Test_FAB7058_30000TX_1ch_12ord_5kb(t *testing.T) {
        passResult, finalResultSummaryString := ote("FAB-7058", 30000, 1, 12, "kafka", 5, spyOff, 1 )
        if !passResult { t.Error(finalResultSummaryString) }
}
...
func Test_FAB7059_30000TX_1ch_12ord_5kb_500batchsize(t *testing.T) {
        passResult, finalResultSummaryString := ote("FAB-7059", 30000, 1, 12, "kafka", 5, spyOff, 1 )
        if !passResult { t.Error(finalResultSummaryString) }
}
...
func Test_FAB7060_30000TX_3ch_12ord_5kb(t *testing.T) {
        passResult, finalResultSummaryString := ote("FAB-7060", 30000, 3, 12, "kafka", 5, spyOff, 1 )
        if !passResult { t.Error(finalResultSummaryString) }
}
...
func Test_FAB7061_30000TX_3ch_12ord_5kb_500batchsize(t *testing.T) {
        passResult, finalResultSummaryString := ote("FAB-7061", 30000, 3, 12, "kafka", 5, spyOff, 1 )
        if !passResult { t.Error(finalResultSummaryString) }
}
