...
//FAB-7058 - send 30000 txns to 12 orderers, 5 kafka brokers, 3 zookeepers with default batchsize and default payload
func Test_FAB7058_30000TX_1ch_12ord_5kb(t *testing.T) {
        passResult, finalResultSummaryString := ote("FAB-7058", 30000, 1, 12, "kafka", 5, spyOff, 1, 0 )
        if !passResult { t.Error(finalResultSummaryString) }
}

//FAB-7078 - send 30000 txns to 12 orderers, 5 kafka brokers, 3 zookeepers with default batchsize and higher payload
func Test_FAB7078_30000TX_1ch_12ord_5kb_10kpayload(t *testing.T) {
        passResult, finalResultSummaryString := ote("FAB-7078", 30000, 1, 12, "kafka", 5, spyOff, 1, 10 )
        if !passResult { t.Error(finalResultSummaryString) }
}

//FAB-7059 - send 30000 txns to 12 orderers 5 kafka brokers, 3 zookeepers with higher batchsize and default payload
func Test_FAB7059_30000TX_1ch_12ord_5kb_500batchsize(t *testing.T) {
        passResult, finalResultSummaryString := ote("FAB-7059", 30000, 1, 12, "kafka", 5, spyOff, 1, 0 )
        if !passResult { t.Error(finalResultSummaryString) }
}

//FAB-7079 - send 30000 txns to 12 orderers 5 kafka brokers, 3 zookeepers with higher batchsize and higher payload
func Test_FAB7079_30000TX_1ch_12ord_5kb_500batchsize_10kpayload(t *testing.T) {
        passResult, finalResultSummaryString := ote("FAB-7079", 30000, 1, 12, "kafka", 5, spyOff, 1, 10 )
        if !passResult { t.Error(finalResultSummaryString) }
}

//FAB-7060 - send 30000 txns to 12 orderers, 5 kafka brokers, 3 zookeepers with default batchsize and default payload
func Test_FAB7060_30000TX_3ch_12ord_5kb(t *testing.T) {
        passResult, finalResultSummaryString := ote("FAB-7060", 30000, 3, 12, "kafka", 5, spyOff, 1, 0 )
        if !passResult { t.Error(finalResultSummaryString) }
}

//FAB-7080 - send 30000 txns to 12 orderers, 5 kafka brokers, 3 zookeepers with default batchsize and higher payload
func Test_FAB7080_30000TX_3ch_12ord_5kb_10kpayload(t *testing.T) {
        passResult, finalResultSummaryString := ote("FAB-7080", 30000, 3, 12, "kafka", 5, spyOff, 1, 10 )
        if !passResult { t.Error(finalResultSummaryString) }
}

//FAB-7061 - send 30000 txns to 12 orderers, 5 kafka brokers, 3 zookeepers with higher batchsize and default payload
func Test_FAB7061_30000TX_3ch_12ord_5kb_500batchsize(t *testing.T) {
        passResult, finalResultSummaryString := ote("FAB-7061", 30000, 3, 12, "kafka", 5, spyOff, 1, 0 )
        if !passResult { t.Error(finalResultSummaryString) }
}

//FAB-7081 - send 30000 txns to 12 orderers, 5 kafka brokers, 3 zookeepers with higher batchsize and higher payload
func Test_FAB7081_30000TX_3ch_12ord_5kb_500batchsize_10kpayload(t *testing.T) {
        passResult, finalResultSummaryString := ote("FAB-7081", 30000, 3, 12, "kafka", 5, spyOff, 1, 10 )
        if !passResult { t.Error(finalResultSummaryString) }
}
