...
# directory.  The script only executes 1 part of traffic from one host. Script runRemoteScenarios.sh can be used to execute this scripts
# on mutiple remote hosts.  The usage of runRemoteScenarios.sh is given in PTE/CITest/README. Note that change chan0 below to 10 and 19 in
# the 2nd and 3rd host respectively.
