...
#### Put the new index file in the chaincode installation folder
cp ../FAB-8251/indexes/index2nd.json ../../../../fabric/examples/chaincode/go/marbles02/META-INF/statedb/couchdb/indexes/
