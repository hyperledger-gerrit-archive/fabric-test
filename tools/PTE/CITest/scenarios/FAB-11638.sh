...
procTX() {
    ...
    echo "./gen_cfgInputs.sh -d $LSCDir -n testorgschannel1 --norg 2 --keystart $keyStart --targetpeers $tPeers --chkpeers $chkPeers --chktx $chktx -a samplecc --nreq $NREQ --nproc $NTHREAD -t $invokeType >& $IPTELOG"
          ./gen_cfgInputs.sh -d $LSCDir -n testorgschannel1 --norg 2 --keystart $keyStart --targetpeers $tPeers --chkpeers $chkPeers --chktx $chktx -a samplecc --nreq $NREQ --nproc $NTHREAD -t $invokeType >& $IPTELOG
