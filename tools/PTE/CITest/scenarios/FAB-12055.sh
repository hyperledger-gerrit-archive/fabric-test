...
#    ./FAB-12055.sh <opt>
#        opt:
#            network: use NL to bring up the bare bones network, create/join channel and install/instantiate cc
#            else (default): use existing network assuming the PTE network json files are located in PTE/FAB-10255-SC
