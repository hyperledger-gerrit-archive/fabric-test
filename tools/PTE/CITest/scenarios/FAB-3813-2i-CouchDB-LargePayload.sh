...
./test_driver.sh -n -m FAB-3813-2i-CouchDB-LargePayload -p -c samplecc -t FAB-3810-2q
...
./test_driver.sh -t FAB-3813-2i-CouchDB-LargePayload
#### gather TPS from docker containers
./get_peerStats.sh -r FAB-3813-2i-CouchDB-LargePayload -p peer0.org1.example.com peer0.org2.example.com -c testorgschannel1 -n $PREFIX -o $CWD -v
