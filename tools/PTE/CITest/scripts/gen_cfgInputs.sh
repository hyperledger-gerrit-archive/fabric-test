...
usage () {
    ...
    echo -e "-a, --app\tblank-separated list of chaincodes, [sample_cc|sample_js|sample_java|marbles02_go|sample_sbe]"
    echo -e "\t\t(Default: None)"
    ...
    echo -e "./gen_cfgInputs.sh -d CPDir --nchan 3 --chanprefix testorgschannel --norg 2 -a marbles02_go sample_cc sample_sbe -i"
...
CCPathsbecc="github.com/hyperledger/fabric-test/chaincodes/sbe"
CCPathsbecc="${CCPathsbecc//\//\\/}"
