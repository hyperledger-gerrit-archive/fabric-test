...
usage () {
    ...
    echo -e "requirement: a directory contains the service credential file in PTE dir"
    ...
    echo -e "./gen_cfgInputs.sh -d SCDir --nchan 3 --chanprefix testorgschannel --norg 2 -a samplecc --freq 10 --rundur 50 --nproc 1 --keystart 100 --targetpeers ORGANCHOR --chkpeers ORGANCHOR -t move"
    echo
    exit
}
