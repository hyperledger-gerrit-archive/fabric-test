...
* ### command
        ...
        ./test_driver.sh [opt] [values]
                ...
                -m: directory containing test_nl.sh to be used to create network and PTE config input files to be used to configure channels and to installe and instantiate chaincode, default=scripts
...
* ### Log
    ...
    - For example, `PTE/CITest/Logs/FAB-3811-2q_1027105544.log` is the log of executing  test case FAB-3808-2i in Oct. 27, 10:55:44.
