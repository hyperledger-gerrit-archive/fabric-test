...
k8s_testsuite='../../../tools/PTE/CITest/k8s_testsuite'
...
queryCountFailure =     "Error: incorrect number of QUERY transactions sent or received"
    ...
    def test_networkLaunch(self):
        ...
        # Launch the network
        returncode = subprocess.call("./operator.sh -s", cwd=k8s_testsuite/scripts, shell=True)
    ...
    def test_FAB-3833-2i(self):
        ...
        returncode = subprocess.call("./operator.sh -FAB-3833-2i", cwd=k8s_testsuite/scripts, shell=True)
        self.assertEqual(returncode, 0, msg=testScriptFailed)
    ...
    def test_FAB-3810-2q(self):
        ...
        # Run the test scenario: launch network and run the invokes and query tests.
        returncode = subprocess.call("./operator.sh -FAB-3810-2q", cwd=k8s_testsuite/scripts, shell=True)
        self.assertEqual(returncode, 0, msg=testScriptFailed)
