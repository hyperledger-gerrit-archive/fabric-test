...
installInstantiate() {
  ...
  export hfc_logging='{"debug":"console"}'
  ./gen_cfgInputs.sh -d "$ConnProfile" --nchan 5 --chan0 0 --chantxpath "$Chantxpath" --chanprefix testorgschannel --norg 4 --tls "$1" -a samplecc samplejs -i > "$LogsDir"/"$2"_installInstantiate.log
  sleep 60
}
...
samplecc_go_2chan() {
  ...
  echo "-------> Execute Invoke"
  export hfc_logging='{"debug":"console"}'
  ./gen_cfgInputs.sh -d "$ConnProfile" --nchan 2 --chan0 0 --norg 2 --chanprefix testorgschannel --chantxpath "$Chantxpath" --tls "$1" --payloadmin 0 --payloadmax 1024 -a samplecc --freq 100 --nreq 1000 --nproc 2 --targetpeers ORGANCHOR -t move > "$LogsDir"/"$2"_samplecc_go_2chan_i.log
  sleep 30
  ...
  echo "-------> Execute Query"
  export hfc_logging='{"debug":"console"}'
  ./gen_cfgInputs.sh -d "$ConnProfile" --nchan 2 --chan0 0 --norg 2 --chanprefix testorgschannel --chantxpath "$Chantxpath" --tls "$1" -a samplecc --freq 100 --nreq 1000  --nproc 2 --targetpeers ORGANCHOR -t query > "$LogsDir"/"$2"_samplecc_go_2chan_q.log
  sleep 30
...
samplejs_node_2chan() {
  cd "$PTEDir"/CITest/scripts || exit 1
  echo "-------> Execute Invoke"
  ./gen_cfgInputs.sh -d "$ConnProfile" --nchan 2 --chan0 0 --norg 2 --chantxpath "$Chantxpath" --chanprefix testorgschannel --tls "$1" --payloadmin 1024 --payloadmax 10240 -a samplejs --freq 100 --nreq 1000 --nproc 2 --targetpeers ORGANCHOR -t move > "$LogsDir"/"$2"_samplejs_node_2chan_i.log
  ...
  sleep 30
  echo "-------> Execute Query"
  ./gen_cfgInputs.sh -d "$ConnProfile" --nchan 2 --chan0 0 --norg 2 --chantxpath "$Chantxpath" --chanprefix testorgschannel --tls "$1" -a samplejs --freq 100 --nreq 1000  --nproc 2 --targetpeers ORGANCHOR -t query > "$LogsDir"/"$2"_samplejs_node_2chan_q.log
...
samplecc_go_12hr() {
  cd "$PTEDir"/CITest/scripts || exit 1
  echo "-------> Execute Invoke"
  ./gen_cfgInputs.sh -d "$ConnProfile" --nchan 2 --chan0 0 --norg 2 --chanprefix testorgschannel --chantxpath "$Chantxpath" --tls "$1" --payloadmin 0 --payloadmax 1024 -a samplecc --freq 100 --rundur 43200 --nproc 2 --targetpeers ORGANCHOR -t move > "$LogsDir"/"$2"_samplecc_go_2chan_12hr_i.log
  sleep 30
...
samplecc_go_8MB_TX() {
  cd "$PTEDir"/CITest/scripts || exit 1
  echo "-------> Execute Invoke"
  ./gen_cfgInputs.sh -d "$ConnProfile" --nchan 2 --chan0 0 --norg 2 --chanprefix testorgschannel --chantxpath "$Chantxpath" --tls "$1" --payloadmin 4194304 --payloadmax 4194304 -a samplecc --freq 1000 --nreq 10 --nproc 1 --targetpeers ORGANCHOR -t move > "$LogsDir"/"$2"_samplecc_go_8MB_i.log
  sleep 30
...
samplecc_go_98MB_TX() {
  cd "$PTEDir"/CITest/scripts || exit 1
  echo "-------> Execute Invoke"
  ./gen_cfgInputs.sh -d "$ConnProfile" --nchan 1 --chan0 0 --norg 1 --chanprefix testorgschannel --chantxpath "$Chantxpath" --tls "$1" --payloadmin 51380224 --payloadmax 51380224 -a samplecc --freq 10000 --nreq 1 --nproc 1 --targetpeers ORGANCHOR -t move > "$LogsDir"/"$2"_samplecc_go_98MB_i.log
  sleep 60
...
samplecc_go_50MB_TX() {
  cd "$PTEDir"/CITest/scripts || exit 1
  echo "-------> Execute Invoke"
  ./gen_cfgInputs.sh -d "$ConnProfile" --nchan 1 --chan0 0 --norg 1 --chanprefix testorgschannel --chantxpath "$Chantxpath" --tls "$1" --payloadmin 26214400 --payloadmax 26214400 -a samplecc --freq 60000 --nreq 2 --nproc 1 --targetpeers ORGANCHOR -t move > "$LogsDir"/"$2"_samplecc_go_50MB_i.log
  sleep 60
