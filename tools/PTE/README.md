...
If you started a network using [Network Launcher](../NL/) and specified an oranization map JSON to create organizations with custom names and MSPs with custom IDs, you will need to create Service Credential files and test case files with the appropriate organization names.
...
```
_Note_: You should write a script to automate such replacements for larger organization maps.
