...
* **ordererOpt**: transaction orderer options
    * **method**: orderer selection method, default: `UserDefined`
         * **UserDefined**: the orderer defined in the `ordererID` in the service credentials file for each org is used for transactions, see ordererID in service credentials file for details
         * **RoundRobin**: an orderer is assigned to each thread in the round robin fashion
