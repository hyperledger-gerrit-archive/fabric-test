...
2. Download or update fabric, and fabric-ca sources, see [Hyperledger fabric-test](https://github.com/hyperledger/fabric-test) for details:
    ...
    - if first time:
         ...
         - `git submodule foreach git pull origin release-1.4`
    - else:
         - `git submodule foreach git pull origin release-1.4`
...
- Using the Fabric e2e example:
    ...
    - `./network_setup.sh up`
- Alternatively, by using the [NetworkLauncher](https://github.com/hyperledger/fabric-test/tree/release-1.4/tools/NL) tool:
...
## CI Test
A set of predefined tests are designed for CI daily or weekly execution and are available in the directory, [CITest](https://github.com/hyperledger/fabric-test/tree/release-1.4/tools/PTE/CITest), under PTE.
