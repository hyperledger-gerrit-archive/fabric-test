...
PTE can be extended to support transaction generation according to a particular stasticial distribution, or even a custom schedule. Two distributions have currently been implemented:
