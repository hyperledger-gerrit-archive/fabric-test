...
function execModeBurst() {
    ...
    logger.info('[Nid:chan:org:id=%d:%s:%s:%d execModeBurst] Burst setting: total modes=',Nid, channelName, org, pid, bTotalModes);
    logger.info('[Nid:chan:org:id=%d:%s:%s:%d execModeBurst] Burst setting: bFreq= %j',Nid, channelName, org, pid, bFreq);
    logger.info('[Nid:chan:org:id=%d:%s:%s:%d execModeBurst] Burst setting: bDur = %j',Nid, channelName, org, pid, bDur);
