        ...
        if ( transType == 'INSTALL' ) {
            ...
            if ((channelOpt.action.toUpperCase() == 'CREATE') || (channelOpt.action.toUpperCase() == 'UPDATE')) {
                ...
                if (channelConfigDone == 0) {
                    ...
                    logger.error('[performance_main] ERROR: peer channel create/update, extra orgs listed, but only one org is required in the orgName list; channelOpt.name: ', channelName);
                }
