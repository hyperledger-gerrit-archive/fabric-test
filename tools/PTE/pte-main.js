                ...
                workerProcess.on('exit', function (code, signal) {
                    ...
                    if ( procDone === nProcPerOrg*channelOrgName.length ) {
                        ...
                        if (totalInvokeTrans>0) {
                            ...
                            output["orderer latency stats (transaction ack)"] = ordererLatencyStats
                        ...
                        if(output["Total transactions"]["sent"] == output["Total transactions"]["received"]){
                            logger.info('[performance_main] Test Result: PASS')
                        } else{
                            logger.info('[performance_main] pte-main:completed:Test Result: FAILED')
                        }
