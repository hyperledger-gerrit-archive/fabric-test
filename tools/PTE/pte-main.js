...
var uiContent = testUtil.setFilePtrSubmitter(uiFile);
...
txCfgPtr = testUtil.setFilePtrSubmitter(txCfgTmp);
...
ccDfnPtr = testUtil.setFilePtrSubmitter(ccDfnTmp);
...
var ORGS = testUtil.setFilePtrSubmitter(svcFile, 'test-network');
