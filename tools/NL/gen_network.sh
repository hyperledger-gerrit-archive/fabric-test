...
function printHelp {
   ...
   echo " "
   echo "Example:"
   echo "   ./gen_network.sh -a create -x 2 -p 2 -r 2 -o 1 -k 1 -z 1 -t kafka -d goleveldb -F /root/gopath/src/github.com/hyperledger/fabric-test/fabric/common/tools/cryptogen -G /opt/hyperledger/fabric/msp/crypto-config "
   echo "   ./gen_network.sh -a create -x 2 -p 2 -r 2 -o 1 -k 1 -z 1 -t kafka -d goleveldb -F /root/gopath/src/github.com/hyperledger/fabric-test/fabric/common/tools/cryptogen -G /opt/hyperledger/fabric/msp/crypto-config -S enabled "
   echo " "
   exit
}
