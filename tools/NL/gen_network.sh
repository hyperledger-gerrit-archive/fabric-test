...
while getopts ":x:z:l:q:d:t:a:o:k:e:p:r:F:G:S:m:C:M:" opt; do
  case $opt in
    ...
    x)
      ...
      ;;
    l)
      PEER_FABRIC_LOGGING_SPEC=peer,endorser,committer=$OPTARG:$PEER_FABRIC_LOGGING_SPEC
    ...
    t)
      ...
      ;;
    q)
      ORDERER_FABRIC_LOGGING_SPEC=orderer=$OPTARG:$ORDERER_FABRIC_LOGGING_SPEC
