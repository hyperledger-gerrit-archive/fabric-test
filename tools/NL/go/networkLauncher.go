...
func (n *NetworkLauncher) ExecuteCommand(name string, args []string) error {
...
func (n *NetworkLauncher) NetworkCleanUp(networkSpec Config, kubeConfigPath string) error {
...
func (n *NetworkLauncher) ReadArguments() (*string, *string, string) {
