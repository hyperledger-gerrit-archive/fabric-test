...
The script generates the service credential json and yaml files of a network to be used as an input to [PTE](https://github.com/hyperledger/fabric-test/tree/master/tools/PTE).
