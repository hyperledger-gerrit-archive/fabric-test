...
## Notes
   ...
   A newer version of docker-compose may be needed if gen_network.sh fails to bring up the network in local host.  Below are the steps to upgrade docker-compose:
