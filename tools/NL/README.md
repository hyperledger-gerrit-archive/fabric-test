...
The following commands will generate a network:
    ...
    ./networkLauncher.sh -o 1 -x 5 -r 5 -p 1 -k 1 -z 1 -n 1 -C trade.com -M ../PTE/ccArgumentsGenerators/ccchecker/orgMap.json -t kafka -f test -w localhost -S enabled
...
_Note_: If you are going to run other tools (like PTE) on this network, you will need to configure the template files suitably with your custom organization names and MSP IDs.
