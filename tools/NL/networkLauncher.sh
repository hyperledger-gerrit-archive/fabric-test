...
function printHelp {
   ...
   echo " ./networkLauncher.sh -o 1 -x 5 -r 5 -p 1 -k 1 -z 1 -n 1 -C trade.com -M ../PTE/ccArgumentsGenerators/ccchecker/orgMap.json -t kafka -f test -w localhost -S enabled"
   exit
}
