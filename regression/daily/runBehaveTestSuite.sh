...
cd ../../feature
behave --junit --junit-directory ../regression/daily/. --tags=-skip --tags=daily -k -D logs=y -i chaincodes.feature &> behave_tests.log && echo "------> Behave feature tests completed."
archiveBehave
