...
class TimedRun_12Hr(unittest.TestCase):
    ...
    def test_FAB_7204_samplejsCC_2chan_x_2_x_10tps(self):
        ...
        self.assertIn("FAB-7204-4i-pteReport.log", logfilelist, msg="Test did not finish; fabric-test/tools/PTE/CITest/Logs/FAB-7204-4i-pteReport.log file not foundin ")
