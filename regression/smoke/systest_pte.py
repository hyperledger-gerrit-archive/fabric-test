...
class Perf_Stress_CouchDB(unittest.TestCase):
    ...
    def test_FAB3833_2i(self):
        ...
        result = subprocess.check_output("./test_driver.sh -e -p FAB3833-2i", cwd='cd ../../fabric-sdk-node/test/PTE/CITest/scripts', shell=True)
...
class Perf_Stress_LevelDB(unittest.TestCase):
    ...
    def test_FAB3808_2i(self):
        ...
        result = subprocess.check_output("./test_driver.sh -e -p FAB3808-2i", cwd='cd ../../fabric-sdk-node/test/PTE/CITest/scripts', shell=True)
