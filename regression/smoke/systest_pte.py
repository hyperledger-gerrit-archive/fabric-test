...
class PTE_Functions(unittest.TestCase):
    ...
    def test_FAB7929_8i(self):
        ...
        # Check log file for each expected output lines.
        #
        ...
        # First check if the test finished and the report file was created
        subprocess.check_output( "ls FAB-7929-8i-pteReport.log ; exit 0",
                                 cwd=logs_directory, stderr=subprocess.STDOUT, shell=True)
