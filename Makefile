...
.PHONY: ci-smoke
ci-smoke: git-init git-latest fabric ca clean pre-setup pull-images javaenv smoke-tests
...
.PHONY: ci-daily
ci-daily: git-init git-latest fabric ca clean pre-setup pull-images javaenv daily-tests
