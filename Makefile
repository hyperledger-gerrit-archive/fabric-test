...
javaenv: fabric-chaincode-java
	@cd $(CHAINCODE-JAVA_DIR) && ./gradlew build
...
interop-fabric: git-init git-latest clean pre-setup fabric pull-thirdparty-images pull-fabric build-fabric pull-binaries-fabric-ca build-fabric-ca build-sdk-wrapper interop-tests

.PHONY: interop-fabric-ca
interop-fabric-ca: fabric pull-thirdparty-images pull-fabric-ca pull-binaries-fabric build-fabric-ca build-sdk-wrapper interop-tests

.PHONY: interop-fabric-sdk-node
interop-fabric-sdk-node: fabric pull-thirdparty-images pull-binaries pull-fabric-sdk-node build-sdk-wrapper interop-tests

.PHONY: interop-fabric-sdk-java
interop-fabric-sdk-java: fabric pull-thirdparty-images pull-binaries pull-fabric-sdk-java build-sdk-wrapper interop-tests

.PHONY: interop-fabric-javaenv
interop-fabric-javaenv: fabric pull-thirdparty-images pull-binaries pull-fabric-javaenv javaenv build-sdk-wrapper interop-tests
