...
.PHONY: ci-smoke
ci-smoke: pre-req pull-images fabric pull-binaries pull-thirdparty-images build-fabric-ca build-sdk-wrapper smoke-tests
...
.PHONY: svt-smoke
svt-smoke: pre-req fabric pull-images pull-binaries pull-thirdparty-images build-sdk-wrapper smoke-tests
