...
.PHONY: ci-smoke
ci-smoke: git-update pre-setup fabric ca docker-images smoke-tests clean-all
...
.PHONY: ci-daily
ci-daily: git-update pre-setup fabric ca docker-images daily-tests clean-all
