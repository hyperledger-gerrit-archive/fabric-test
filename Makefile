...
git-latest:
	...
	cd $(HYPERLEDGER_DIR)/fabric-test/fabric-ca && git checkout master && git fetch origin master && git reset --hard FETCH_HEAD && git show-ref HEAD
	...
	cd $(HYPERLEDGER_DIR)/fabric-test/fabric-sdk-node && git checkout master && git fetch origin master && git reset --hard FETCH_HEAD && git show-ref HEAD
