...
.PHONY: ci-smoke
ci-smoke: git-init git-latest fabric ca clean pre-setup build-docker-images build-sdk-wrapper javaenv smoke-tests
...
.PHONY: ci-daily
ci-daily: git-init git-latest fabric ca clean pre-setup build-docker-images build-sdk-wrapper javaenv daily-tests
