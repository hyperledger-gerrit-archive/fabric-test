...
.PHONY: git-latest
git-latest:
	cd $(HYPERLEDGER_DIR)/fabric-test/cello && git fetch origin master && git reset --hard FETCH_HEAD && git show-ref HEAD
	cd $(HYPERLEDGER_DIR)/fabric-test/fabric && git checkout release-1.1 && git fetch origin release-1.1 && git reset --hard FETCH_HEAD && git show-ref HEAD
	cd $(HYPERLEDGER_DIR)/fabric-test/fabric-ca && git checkout release-1.1 && git fetch origin release-1.1 && git reset --hard FETCH_HEAD && git show-ref HEAD
	cd $(HYPERLEDGER_DIR)/fabric-test/fabric-samples && git checkout release-1.1 && git fetch origin release-1.1 && git reset --hard FETCH_HEAD && git show-ref HEAD
	cd $(HYPERLEDGER_DIR)/fabric-test/fabric-sdk-node && git checkout release-1.1 && git fetch origin release-1.1 && git reset --hard FETCH_HEAD && git show-ref HEAD
...
fabric:
	...
	cd $(FABRIC_DIR) && git checkout release-1.1 && git fetch origin release-1.1 && git reset --hard FETCH_HEAD && git show-ref HEAD
...
ca:
	...
	cd $(CA_DIR) && git checkout release-1.1 && git fetch origin release-1.1 && git reset --hard FETCH_HEAD && git show-ref HEAD
