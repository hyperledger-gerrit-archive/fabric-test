...
.PHONY: ci-smoke
ci-smoke: fabric pull-images pull-binaries smoke-tests
#ci-smoke: fabric pull-images pull-binaries javaenv smoke-tests
...
.PHONY: ci-daily
ci-daily: fabric pull-images pull-binaries daily-tests
#ci-daily: fabric pull-images pull-binaries javaenv daily-tests
