...
#   - pull-javaenv  - clone the fabric-chaincode-java repository and pull the javaenv image.
...
.PHONY: ci-smoke
ci-smoke: git-init git-latest fabric ca clean pre-setup docker-images pull-javaenv smoke-tests
...
.PHONY: ci-daily
ci-daily: git-init git-latest fabric ca clean pre-setup docker-images pull-javaenv daily-tests
...
.PHONY: pull-javaenv
pull-javaenv: fabric-chaincode-java
