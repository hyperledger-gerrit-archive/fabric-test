...
fabric:
	...
	cd $(FABRIC_DIR) && git checkout `cat ../fabric-test/.git/modules/fabric/HEAD`
...
ca:
	...
	cd $(CA_DIR) && git checkout `cat ../fabric-test/.git/modules/fabric-ca/HEAD`
#	cd $(CA_DIR) && git checkout release-1.1
