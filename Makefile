...
interop-fabric: pull-thirdparty-images build-fabric pull-binaries-fabric-ca build-fabric-ca pull-javaenv interop-tests

.PHONY: interop-fabric-ca
interop-fabric-ca: pull-thirdparty-images pull-fabric pull-binaries-fabric build-fabric-ca pull-javaenv interop-tests

.PHONY: interop-fabric-sdk-node
interop-fabric-sdk-node: pull-thirdparty-images pull-binaries pull-fabric-ca pull-javaenv interop-tests

.PHONY: interop-fabric-sdk-java
interop-fabric-sdk-java: pull-thirdparty-images pull-binaries pull-fabric-ca pull-javaenv interop-tests
