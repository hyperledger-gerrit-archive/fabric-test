...
fabric:
	...
	cd $(FABRIC_DIR) && git checkout release-1.1 && git fetch origin release-1.1 && git reset --hard FETCH_HEAD
...
ca:
	...
	cd $(CA_DIR) && git checkout release-1.1 && git fetch origin release-1.1 && git reset --hard FETCH_HEAD
