...
.PHONY: ci-smoke
ci-smoke: pull-images pull-binaries build-sdk-wrapper javaenv smoke-tests
...
.PHONY: ci-daily
ci-daily: pull-images pull-binaries build-sdk-wrapper javaenv daily-tests
...
svt-daily-pte-tests: pull-binaries pull-images fabric
	cd $(HYPERLEDGER_DIR)/fabric-test/regression/daily && ./runPteTestSuite.sh

.PHONY: svt-daily-ote-tests
svt-daily-ote-tests: pull-binaries pull-images fabric
